...
export class PlaybackStatus {
     ...
     * @param {Partial<PlaybackStatus>} [$$source = {}] - The source object to create the PlaybackStatus.
     */
    constructor($$source = {}) {
        if (!("state" in $$source)) {
            /**
    ...
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new PlaybackStatus(/** @type {Partial<PlaybackStatus>} */($$parsedSource));
    }
}
...
export class RadioFavouriteJSON {
     ...
     * @param {Partial<RadioFavouriteJSON>} [$$source = {}] - The source object to create the RadioFavouriteJSON.
     */
    constructor($$source = {}) {
     ...
     * @param {any} [$$source = {}]
     * @returns {RadioFavouriteJSON}
     */
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new RadioFavouriteJSON(/** @type {Partial<RadioFavouriteJSON>} */($$parsedSource));
    }
}
...
export class RadioStationJSON {
     ...
     * @param {Partial<RadioStationJSON>} [$$source = {}] - The source object to create the RadioStationJSON.
     */
    constructor($$source = {}) {
        if (!("uuid" in $$source)) {
            /**
     ...
     * @param {any} [$$source = {}]
     * @returns {RadioStationJSON}
     */
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new RadioStationJSON(/** @type {Partial<RadioStationJSON>} */($$parsedSource));
    }
}
